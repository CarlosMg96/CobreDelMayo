<template>
  <nav class="navbar">
    ...
    <div v-if="language === 'EN'">
      ...
      <ul class="nav-links" :class="{ 'nav-active': isOpen }">
        ...
        <li>
          <router-link to="/history" active-class="active" @click="closeMenu"
            >HISTORY</router-link
          >
        </li>
        <li>
          <router-link to="/location" active-class="active" @click="closeMenu"
            >LOCATION</router-link
          >
        </li>
        <li>
          <router-link to="/operations" active-class="active" @click="closeMenu"
            >OPERATIONS</router-link
          >
        </li>
        <li>
          <router-link to="/esg" active-class="active" @click="closeMenu"
            >ESG</router-link
          >
        </li>
      </ul>
  ...
  <div class="content" :class="{ 'content-blur': isOpen }"></div>
</template>

<script>
import { getLanguage, setLanguage } from "@/kernel/utils";
export default {
  name: "NavbarPublicEs",
  data() {
    return {
