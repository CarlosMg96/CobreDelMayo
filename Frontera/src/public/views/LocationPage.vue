        ...
        <div class="container">
          <div class="philosophy-grid">
            <div class="philosophy-card">
              <div>
                <p>
                  <span v-html="filterData('LOCATION_03_' + language)"></span>
                </p>
              </div>
            </div>
            ...
            <div class="philosophy-card">
              <div>
                <p>
                  <span v-html="filterData('LOCATION_04_' + language)"></span>
                </p>
              </div>
            </div>
            ...
            <div class="philosophy-card">
              <div>
                <p>
                  <span v-html="filterData('LOCATION_05_' + language)"></span>
                </p>
              </div>
            </div>
            ...
            <div class="philosophy-card">
              <div>
                <p>
                  <span v-html="filterData('LOCATION_06_' + language)"></span>
                </p>
              </div>
            </div>
            ...
            <div class="philosophy-card">
              <div>
                <p>
                  <span v-html="filterData('LOCATION_07_' + language)"></span>
                </p>
              </div>
            </div>
          </div>
